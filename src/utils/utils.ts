...
import { ClientObject } from "@/types/user.interfaces";

import ApiError from "./ApiError";
import messages from "./messages";

const stringToObject = (stringText: string): ClientObject =>
  JSON.parse(stringText) as ClientObject;

interface IxypClient extends ClientObject {
  platform: string;
  ip: string;
}

const XYP = "x-yp-client";
...
const verifyCountryCode = (code: string): void => {
