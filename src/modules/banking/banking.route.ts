...
import activityController from "./banking.controller";
import routeDetails, { IActivityRouteDetails } from "./banking.route.details";
import activityValidation from "./banking.validation";
